...
class TrajectoryBalance(GFlowNetObjective):
    ...
    def compute_loss(self, 
        ...
        metrics = {
            ...
            'tb_error_abs_mean': tb_error.abs().mean().item(),
        }
...
class DetailedBalance(GFlowNetObjective):
    ...
    def compute_loss(self,
        ...
        metrics = {
            'db_error_mean': torch.stack(losses).sqrt().mean().item(),
...
class SubTrajectoryBalance(GFlowNetObjective):
    ...
    def compute_loss(self,
        ...
        metrics = {
            ...
            'subtb_avg_length': masks.sum().item() / batch_size,
        }
    ...
    def compute_loss(self,
        ...
        metrics = {
            **tb_metrics,
            ...
            'value_mae': (predicted_log_values - rewards).abs().mean().item(),
        }
...
class EntropyRegularizedObjective(GFlowNetObjective):
    ...
    def __init__(self, base_objective: GFlowNetObjective = None,
    ...
    def compute_loss(self,
        ...
        metrics = {
            **base_metrics,
            'entropy': valid_entropy.mean().item() if len(valid_entropy) > 0 else 0.0,
